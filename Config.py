...
class ModelConfig():
    ...
    def __addArguments(self):
        ...
        self.__parser.add_argument('--lambda_penalty',
                                   '-p',
                                   default=0.0,
                                   type=float,
                                   help='penalty normalization constant')
        ...
        self.__parser.add_argument('--hidden_size',
                                   ...
                                   default=200,
                                   type=int,
                                   help='Hidden layer size of feed forward layer')
        self.__parser.add_argument('--rnn_size',
                                   '-rs',
                                   default=200,
                                   type=int,
                                   help='Hidden state size of RNN layer')
        self.__parser.add_argument('--attention_size',
                                   '-as',
                                   default=200,
                                   type=int,
                                   help='Attention layer size')
        self.__parser.add_argument('--self_attention_r',
                                   '-sar',
                                   default=30,
                                   type=int,
                                   help='Nums of attention directions')
